    ...
    <div class="col-sm-10 mx-auto p-5">
        ...
        <nav aria-label="breadcrumb">
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item active" aria-current="page">Casa número: <?= ucfirst($dados['morador']->ds_numero_casa) ?>
            </ol>
        </nav>
                ...
                <form name="editar" method="POST" action="<?= URL . 'Moradores/editarMorador/' . $dados['idMorador'] ?>">
                    <div class="row">
                        <div class="mb-3 col-sm-6">
                            ...
                            <input type="text" class="form-control <?= $dados['nomeProprietario_erro'] ? 'is-invalid' : '' ?>" name="txtNomeProprietario" id="txtNomeProprietario" value="<?= trim($dados['morador']->nm_morador) ?>" maxlength="255">
                        ...
                        <div class="mb-3 col-sm-6">
                            ...
                            <input type="text" placeholder="Somente números" class="form-control <?= $dados['documentoProprietario_erro'] ? 'is-invalid' : '' ?>" name="txtDocumentoProprietario" id="txtDocumentoProprietario" value="<?= trim($dados['morador']->documento_morador) ?>" maxlength="11">
                            <!-- Div para exibir o erro abaixo do campo -->
                    ...
                    <div class="row">
                        <div class="mb-3 col-sm-6">
                            ...
                            <input type="date" class="form-control <?= $dados['dataNascimentoProprieratio_erro'] ? 'is-invalid' : '' ?>" name="dateNascimentoProprietario" id="dateNascimentoProprietario" value="<?= trim($dados['morador']->dt_nascimento_morador) ?>">
                            <!-- Div para exibir o erro abaixo do campo -->
                        ...
                        <div class="mb-3 col-sm-6">
                            ...
                            <input type="text" class="form-control <?= $dados['emailProprietario_erro'] ? 'is-invalid' : '' ?>" name="txtEmailProprietario" id="txtEmailProprietario" value="<?= trim($dados['morador']->email_morador) ?>" maxlength="100">
                    ...
                    <div class="row">
                        <div class="mb-3 col-sm-6">
                            ...
                            <input type="text" placeholder="Somente números" class="form-control <?= $dados['telefone_um_proprietario_erro'] ? 'is-invalid' : '' ?>" name="txtTelefoneUmProprietario" id="txtTelefoneUmProprietario" value="<?= trim($dados['morador']->tel_um_morador) ?>" maxlength="11">
                        ...
                        <div class="mb-3 col-sm-6">
                            ...
                            <input type="text" placeholder="Somente números" class="form-control" name="txtTelefoneDoisProprietario" id="txtTelefoneDoisProprietario" value="<?= trim($dados['morador']->tel_dois_morador) ?>" maxlength="11">
                    ...
                    <div class="row">
                        <div class="mb-3 col-sm-6">
                            ...
                            <input type="text" placeholder="Somente números" class="form-control" name="txtTelefoneEmergenciaProprietario" id="txtTelefoneEmergenciaProprietario" value="<?= trim($dados['morador']->tel_emergencia) ?>" maxlength="11">
                        </div>
                        ...
                        <div class="mb-3 col-sm-6">
                            ...
                            <select class="form-select <?= $dados['cboCasa_erro'] ? 'is-invalid' : '' ?>" name="cboCasa" id="cboCasa">
                                ...
                                <?php foreach ($dados['casas'] as $casa) {
                                    ...
                                    $casaSelected = '';
                                    if ($casa->id_casa == $dados['morador']->fk_casa) {
                    ...
                    <div class="row mt-4">
                        <div class="mb-3 col-sm-6">
                            <div class="form-check">
                                ...
                                ?>
                                <input class="form-check-input" type="checkbox" value="S" id="chkLocatario" name="chkLocatario" <?= $checkedLocatario ?>>
